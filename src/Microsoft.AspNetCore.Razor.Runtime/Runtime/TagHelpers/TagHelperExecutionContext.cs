...
namespace Microsoft.AspNetCore.Razor.Runtime.TagHelpers
{
    ...
    public class TagHelperExecutionContext
    {
        ...
        /// <param name="structure">The structure of the attribute.</param>
        public void AddHtmlAttribute(string name, object value, HtmlAttributeStructure structure)
        {
            if (name == null)
            {
            ...
            var attribute = new TagHelperAttribute(name, value, structure);
        ...
        /// <param name="structure">The structure of the attribute.</param>
        public void AddTagHelperAttribute(string name, object value, HtmlAttributeStructure structure)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
