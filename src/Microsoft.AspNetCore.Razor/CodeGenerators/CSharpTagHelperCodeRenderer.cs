...
namespace Microsoft.AspNetCore.Razor.CodeGenerators
{
    ...
    public class CSharpTagHelperCodeRenderer
    {
        ...
        private void RenderAttributes(
            IList<TagHelperAttributeChunk> chunkAttributes,
            IEnumerable<TagHelperDescriptor> tagHelperDescriptors)
        {
        ...
        private string RenderBoundAttribute(
            TagHelperAttributeChunk attribute,
            ...
            TagHelperAttributeDescriptor attributeDescriptor)
        {
            ...
            if (previousValueAccessor == null)
            {
                ...
                _writer
                    ...
                    .WriteParameterSeparator()
                    .Write($"global::{typeof(HtmlAttributeStructure).FullName}.{attribute.Structure}")
                    .WriteEndMethodInvocation();
        ...
        private void RenderUnboundAttribute(TagHelperAttributeChunk attribute)
        {
            ...
            var attributeStructureParameter = $"global::{typeof(HtmlAttributeStructure).FullName}.{attribute.Structure}";
            ...
            else if (IsDynamicAttributeValue(attribute.Value))
            {
                ...
                _writer
                    ...
                    .WriteParameterSeparator()
                    .Write(attributeStructureParameter)
                    .WriteEndMethodInvocation();
            ...
            else if (attribute.Structure == HtmlAttributeStructure.Minimized ||
                TryGetPlainTextValue(attribute.Value, out textValue))
            {
                _writer
                    .WriteStartInstanceMethodInvocation(
                        ExecutionContextVariableName,
                ...
                if (attribute.Structure == HtmlAttributeStructure.Minimized)
                {
                    _writer.Write("null");
                }
                else
